...
<img width="1114" height="627" alt="image" src="https://github.com/user-attachments/assets/5e8ab5ee-1aa2-43d4-9f0c-44e7cc399f82" />
...
<p align="center">
<img width="1672" height="587" alt="48D6B5F0-B077-41E3-9FA5-78C50C9B76B9" src="https://github.com/user-attachments/assets/8026699d-e1e5-4779-a235-a288e858cdc4" />
</p>
...
- Redis 캐싱 + 장애 격리 설계 ([6장](#6-기술적으로-고민한-부분) 참고)
...
**"Wara by Gara"** — 8인의 풀스택 개발자로 구성된 팀이 기획부터 배포·운영까지 함께 만들었습니다.
...
<br>
<img width="1448" height="1086" alt="image" src="https://github.com/user-attachments/assets/a1c66e91-fe13-474e-a87e-46d4be7bb780" />
...
## 7-1. 부하 테스트로 검증한 DB 인덱스 최적화 — 530배 개선
...
## 7-3. 실시간 위치 공유의 프라이버시 설계 — 3단계 티어와 좌표 마스킹
...
## 7-4. 외부 API 장애 격리 — 서킷 브레이커와 타임아웃 폴백
...
## 7-5. 실시간 아키텍처 — Socket.IO 선택과 동시성 제어
...
## 7-6. 파일 업로드 파이프라인 — Presigned URL과 검증 계층
