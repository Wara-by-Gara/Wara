...
const TEMPLATE_DEFS = [
  ...
  { key: 'tmpl2',  name: '생일 축하',     theme: 'birthday', font: 'elegant-serif', effect: 'sparkle',  bgColor: 'bg-invite-pastel', animation: 'paper', isActive: true, previewFolder: 'birthday', previewFile: 'birthday_cover_image.jpg',
  ...
  { key: 'tmpl7',  name: '저녁약속',      theme: 'food',     font: 'highteen', effect: null,       bgColor: 'bg-invite-starry', animation: 'stream', isActive: true, previewFolder: 'dinner-party', previewFile: 'dinner_cover_image.jpg',
