...
ALTER TABLE "invitations" ADD COLUMN "main_image_frame" varchar(10) DEFAULT 'default' NOT NULL;--> statement-breakpoint
ALTER TABLE "invitations" ADD COLUMN "uploaded_image_key" text;--> statement-breakpoint
