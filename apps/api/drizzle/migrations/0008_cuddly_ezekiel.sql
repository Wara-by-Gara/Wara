ALTER TYPE "public"."notification_type" ADD VALUE IF NOT EXISTS 'ai_complete';--> statement-breakpoint
...
CREATE INDEX "idx_ai_jobs_status" ON "ai_image_jobs" USING btree ("status");