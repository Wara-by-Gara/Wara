export const ErrorCode = {
  ...
  PHOTO_INVALID_MIME: 'PHOTO_INVALID_MIME',
  ...
  PARTICIPANT_NOT_ATTENDING: 'PARTICIPANT_NOT_ATTENDING',
  OWNER_CANNOT_BE_DEMOTED: 'OWNER_CANNOT_BE_DEMOTED',
  ...
  VOTE_SLOT_DUPLICATE: 'VOTE_SLOT_DUPLICATE',
  VOTE_SLOT_TYPE_MISMATCH: 'VOTE_SLOT_TYPE_MISMATCH',
  VOTE_EVENT_DATE_SET: 'VOTE_EVENT_DATE_SET',
  // 비용 정산
  SETTLEMENT_NOT_FOUND: 'SETTLEMENT_NOT_FOUND',
  SETTLEMENT_EXPENSE_NOT_FOUND: 'SETTLEMENT_EXPENSE_NOT_FOUND',
  SETTLEMENT_FORBIDDEN: 'SETTLEMENT_FORBIDDEN',
  SETTLEMENT_CONFIRMED: 'SETTLEMENT_CONFIRMED',
  SETTLEMENT_PARTICIPANT_INVALID: 'SETTLEMENT_PARTICIPANT_INVALID',
  SETTLEMENT_SHARE_DISABLED: 'SETTLEMENT_SHARE_DISABLED',
  // 콘텐츠 신고/모데레이션
  ...
  TEXT_BLAST_NOT_FOUND: 'TEXT_BLAST_NOT_FOUND',
