    ...
    if (variant === "online") {
      return (
        <div
          ...
          {...props}
        >
          <span className="inline-flex size-11 shrink-0 items-center justify-center rounded-2xl bg-blue-100 text-blue-500">
            ...
            {address && (
              <>
                ...
                <button
                  ...
                  className="inline-flex align-middle rounded-md p-1 text-text-tertiary hover:bg-gray-100 hover:text-text-primary transition-colors duration-150"
                >
