  ...
  function InvitationCard(
    ...
    return (
      <button
        ...
        type="button"
        className={cn(
          "group flex w-full flex-col gap-3 overflow-hidden rounded-3xl border border-border bg-surface p-3 text-left shadow-xs hover:shadow-sm transition-shadow duration-200",
