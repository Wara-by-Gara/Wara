...
const canViewFeed = !!myParticipant;
  ...
  const isDarkBg = !!gradientVariant || invitation.bgColor.includes('aurora') || invitation.bgColor.includes('starry') || invitation.bgColor.includes('dreamy') || invitation.bgColor.includes('galaxy') || invitation.bgColor.includes('lasershow');
