...
import type { getInvitation, Invitation as InvitationListItem } from "@/lib/api/invitations";
      ...
      <TopAppBar
        ...
        rightSlot={
          <div className="flex items-center gap-1">
            ...
            <ImmersiveTopBarButton aria-label="더보기" onClick={() => setMoreSheetOpen(true)}>
      ...
      <main className="flex min-h-0 flex-1 flex-col gap-5 overflow-y-auto px-page pb-6">
        <div className="flex flex-col gap-2">
          <InvitationDetailHero
            ...
            schedule={schedule}
            fontClass={fontClass}
            meta={<Badge variant="host" size="md">호스트</Badge>}
            cover={
              <InvitationCover
