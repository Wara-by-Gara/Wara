...
const circleVariants = cva(
  [
    ...
    // 흰 glow는 inset(안쪽)으로 가장자리 페더 — 경계 밖으로 안 번짐. 떠 보이는 건 어두운 드롭섀도로.
    "shadow-[inset_0_0_10px_1px_rgba(255,255,255,0.35),0_14px_30px_-12px_rgba(0,0,0,0.22)]",
  ],
  {
    variants: {
      size: {
      ...
      state: {
        ...
        selected:
          "scale-[1.06] [background:radial-gradient(circle_at_50%_40%,rgba(255,255,255,1)_0%,rgba(255,255,255,0.85)_55%,rgba(255,255,255,0.35)_100%)] shadow-[inset_0_0_22px_3px_rgba(255,255,255,0.9),0_16px_34px_-12px_rgba(0,0,0,0.3)]",
