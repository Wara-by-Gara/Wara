...
export const QrCode: Story = {
  args: { icon: "qrcode", title: "QR 코드 보기", iconBg: "bg-blue-100", iconColor: "text-blue-500" },
};

export const SaveImage: Story = {
  args: { icon: "download", title: "이미지로 저장", iconBg: "bg-cranberry-10", iconColor: "text-cranberry-60" },
};
...
export const AllOptions: Story = {
  render: () => (
    <div className="flex flex-col gap-1">
      ...
      <ShareOptionItem icon="send" title="문자 공유" iconBg="bg-blue-100" iconColor="text-blue-500" />
