...
export const DefaultApple: Story = { name: "Default - Apple", args: { thirdProvider: "apple" } };
...
export const SessionExpiredModal: Story = { args: { state: "sessionExpiredModal" } };
export const LoginRequiredBottomSheet: Story = { args: { state: "loginRequiredBottomSheet" } };
export const ContinueWithoutLogin: Story = { args: { state: "continueWithoutLogin" } };
