...
| 온보딩 | /onboarding | — | 📱 P1 | R-REENMY |
| 약관 동의 | /terms/agree | app/terms-agree | ✅ | F-YECRCZ |
| 약관 전문(서비스/개인정보/위치) | /terms/service·privacy·location | settings/terms (단일) | 📱 P2 분리 | F-MJUIEM |
...
| 초대장 편집 | /invitations/[id]/edit, /edit | — | 📱 P1 (create 마법사 재사용) | F-PFLCKA |
...
| 댓글(활동피드) | /invitations/[id]/comments | — | 📱 P1 | F-DPZZXZ |
| 날짜 투표 | /invitations/[id]/vote | invitations/[id]/vote | ✅ | F-TMAXOC |
| 숨김 목록 | /invitations/hidden | — | 📱 P1 | F-AWFJXB |
...
| 친구 숨김 | /friends/hidden | — | 📱 P1 | S-ROGBNG |
...
| 캘린더 | /calendar | — | 📱 P1 | R-FNIWJR |
| 모임 내역 | /meetings | — | 📱 P1 | F-MPBPAP |
...
| 문의 목록/상세/작성 | /inquiries + /list + /me + /write + /[id] | support/inquiries (단일) | 📱 P2 분리 | F-CJCIXI, F-IOFTOP |
...
1. onboarding (R-REENMY)
2. invitations/[id]/comments (F-DPZZXZ high)
3. invitations/[id]/edit (F-PFLCKA high)
4. meetings (F-MPBPAP high)
5. calendar (R-FNIWJR)
6. invitations/hidden · friends/hidden
